...
\* The file 'NMDAEventsProjecteAj-EEGbeh.csv' can be obtained from REDCap by downloading the export name 'EEG_beh' (that includes the variables 'record_id', 'n_visit', 'testing', 'birthdate', 'gender', 'treatment', 'gaf_v0' and 'gaf'). If needed, rename file to have that exact name.
