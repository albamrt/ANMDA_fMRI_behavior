...
simfolded <- lapply(Sigma, function(x) replicate(1000, 
                                           crossValSigmaFolded(x, data, derivative = 1)))

sim3folded <- lapply(Sigma, function(x) replicate(1000, 
                                            crossValSigmaFolded(x, data, derivative = 3)))

save(simfolded, sim3folded, file = "data/simFolded.RData")
```
...
load(file = 'data/simFolded.RData')

mean_MSE <- unlist(lapply(simfolded, mean))
min_MSE <- min(mean_MSE)
sigma <- Sigma[mean_MSE == min_MSE]

mean_MSE3 <- unlist(lapply(sim3folded, mean))
